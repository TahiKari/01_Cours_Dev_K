...
let tableauGenerique = ['Hi', 3, 20, true, 'true'];
let tableauAny = [1, "a", "Hi", 7, true];
console.log('----------------------------------------');
// Exemple 9 de la vidéo
// Les tuples
// Déclaration et initialisation d'un tuple
let monTuple1 = ['Hi', 2023];
let monTuple2 = [2023, 2025];
// Tuple Vs Tableau Générique
let monTuple3 = [2023, true, 21, "Word"];
let monTableau4 = [2023, 'Hi', 2023]; // Tableau Générique
// Accès aux éléments du tableau
let string1 = monTuple1[0]; // Hi
let number1 = monTuple1[1]; // 2023
...
var Couleur1;
(function (Couleur1) {
    Couleur1[Couleur1["Rouge"] = 0] = "Rouge";
    Couleur1[Couleur1["Orange"] = 1] = "Orange";
    Couleur1[Couleur1["Jaune"] = 2] = "Jaune";
    Couleur1[Couleur1["Vert"] = 3] = "Vert";
    Couleur1[Couleur1["Bleu"] = 4] = "Bleu";
    Couleur1[Couleur1["Indigo"] = 5] = "Indigo";
    Couleur1[Couleur1["Violet"] = 6] = "Violet";
})(Couleur1 || (Couleur1 = {}));
console.log(Couleur1.Violet); // Affiche 6
var Couleur2;
(function (Couleur2) {
    Couleur2[Couleur2["Rouge"] = 1] = "Rouge";
    Couleur2[Couleur2["Orange"] = 2] = "Orange";
    Couleur2[Couleur2["Jaune"] = 3] = "Jaune";
    Couleur2[Couleur2["Vert"] = 4] = "Vert";
    Couleur2[Couleur2["Bleu"] = 5] = "Bleu";
    Couleur2[Couleur2["Indigo"] = 6] = "Indigo";
    Couleur2[Couleur2["Violet"] = 7] = "Violet";
})(Couleur2 || (Couleur2 = {}));
console.log(Couleur2.Violet); // Affiche 7
// Assignation de valeurs personnalisée
var Couleur3;
(function (Couleur3) {
    Couleur3["Rouge"] = "Rouge";
    Couleur3["Orange"] = "Orange";
    Couleur3["Jaune"] = "Jaune";
    Couleur3["Vert"] = "Vert";
    Couleur3["Bleu"] = "Bleu";
    Couleur3["Indigo"] = "Indigo";
    Couleur3["Violet"] = "Violet";
})(Couleur3 || (Couleur3 = {}));
console.log(Couleur3.Violet); // Affiche Violet
// Utilisationd'une énumération
let maCouleur = Couleur1.Rouge;
